...
### 🔹 Features
1. **User Registration** - Users can create accounts to join the platform.  
2. **User Login** - Secure authentication to access the platform.  
3. **Item Management** - Users can **list, browse, and manage** available clothing items categorized for **swap, donation, or borrowing**.  
4. **Logout** - Users can securely log out.  
5. **User-Friendly Interface** - The application dynamically updates based on user interactions.  
